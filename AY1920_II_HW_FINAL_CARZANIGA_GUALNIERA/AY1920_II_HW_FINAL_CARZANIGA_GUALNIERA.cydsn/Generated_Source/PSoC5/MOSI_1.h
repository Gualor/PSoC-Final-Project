...
*/
     ...
     *  @{
     */
        #define MOSI_1_INTR_NONE      (uint16)(0x0000u)
        #define MOSI_1_INTR_RISING    (uint16)(0x0001u)
        #define MOSI_1_INTR_FALLING   (uint16)(0x0002u)
        #define MOSI_1_INTR_BOTH      (uint16)(0x0003u) 
    /** @} intrMode */
/** @} group_constants */

    #define MOSI_1_INTR_MASK      (0x01u) 
#endif /* (MOSI_1__INTSTAT) */
...
/* SIO registers */
#if defined(MOSI_1__SIO_CFG)
    #define MOSI_1_SIO_HYST_EN        (* (reg8 *) MOSI_1__SIO_HYST_EN)
    #define MOSI_1_SIO_REG_HIFREQ     (* (reg8 *) MOSI_1__SIO_REG_HIFREQ)
    #define MOSI_1_SIO_CFG            (* (reg8 *) MOSI_1__SIO_CFG)
    #define MOSI_1_SIO_DIFF           (* (reg8 *) MOSI_1__SIO_DIFF)
...
/* Interrupt Registers */
	...
	#define MOSI_1_0_INTTYPE_REG 		(* (reg8 *) MOSI_1__0__INTTYPE)
#endif /* (MOSI_1__INTSTAT) */
